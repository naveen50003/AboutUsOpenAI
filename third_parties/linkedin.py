...
def scrape_linedin_profile(linkedin_profile_url: str):
  ...
  # KTR
  # response = requests.get('https://gist.githubusercontent.com/naveen50003/ae987da32ccbf4597bf7b539ece9fc3e/raw/8fe56916bfba1c676a6941b27695d3a7e6894ef5/KTR.json') 
